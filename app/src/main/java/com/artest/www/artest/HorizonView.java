...
/**
 * Created by deveshshetty on 19/07/16.
 */
public class HorizonView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        skyPath.addArc(innerBoundingBox, -rollDegree, (180 + (2 * rollDegree))); canvas.rotate(-tiltDegree, px, py);
        ...
        markerPaint.setStrokeWidth(2); canvas.drawLine(center.x - radius / 2,
                (float)justTiltX,
                center.x + radius / 2,
                (float)justTiltX,
                markerPaint);
